...
Make sure to feed some EVM transactions to setheum node, for example we can use [these evm examples](https://github.com/Setheum-Labs/evm-examples).
...
- run an [Setheum](https://github.com/Setheum-Labs/Setheum) node locally and listen to port 9944 (in terminal 1), and feed EVM data to it
